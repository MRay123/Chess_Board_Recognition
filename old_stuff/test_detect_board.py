...
from old_stuff.detect_board import detect_chessboard
from old_stuff.slice_squares import slice_squares
from old_stuff.detect_board_hough import detect_board_hough
